...
namespace YuoTools
{
    public class YuoTweenCon : SingletonMono<YuoTweenCon>
    {
        ...
        public IEnumerator IFloatTo(float start, float end, float needTime, FloatTo action, float addSpeed = 0, UnityAction EndAction = null, string name = "")
        {
        ...
        public IEnumerator IIntTo(int start, int end, float needTime, IntTo action, float addSpeed = 0, UnityAction EndAction = null)
        {
            float speed = (end - start) / needTime;
            float speedTemp = speed;
            addSpeed *= speed;
    ...
    public static class TweenEx
    {
        ...
        /// <returns></returns>
        public static Coroutine MoveTo(this Transform tran, Vector3 end, float needTime, UnityAction EndAction = null, float delayTime = 0)
        {
            return YuoTweenCon.Instance.StartCoroutine(YuoTweenCon.Instance.MoveTo(tran, end, needTime, EndAction, delayTime));
        }
        ...
        /// <param name="EndAction"></param>
        /// <returns></returns>
        public static Coroutine MoveToCurue(this Transform tran, Vector3 end, float needTime, Vector3 con, UnityAction EndAction = null)
        {
            return YuoTweenCon.Instance.StartCoroutine(YuoTweenCon.Instance.MoveToCurue(tran, end, needTime, con, EndAction));
        }

        public static Coroutine MoveToCurue2D(this Transform tran, Vector2 end, float needTime, float conx, float cony, UnityAction EndAction = null)
        {
            return YuoTweenCon.Instance.StartCoroutine(YuoTweenCon.Instance.MoveToCurue(tran, end, needTime, GetConPostion(tran.position, end, cony, conx), EndAction));
        }
        ...
        public static void To(this float f, string name, float value, float needTime, YuoTweenCon.FloatTo floatTo, float addSpeed = 0, UnityAction action = null)
        {
            YuoTweenCon.Instance.StartTween(YuoTweenCon.Instance.IFloatTo(f, value, needTime, floatTo, addSpeed, action, name), name);
        }

        public static Coroutine To(this float f, float value, float needTime, YuoTweenCon.FloatTo floatTo, float addSpeed = 0, UnityAction action = null)
        {
            return YuoTweenCon.Instance.StartCoroutine(YuoTweenCon.Instance.IFloatTo(f, value, needTime, floatTo, addSpeed, action));
        }

        public static Coroutine To(this int f, int value, float needTime, YuoTweenCon.IntTo floatTo, float addSpeed = 0, UnityAction action = null)
        {
            return YuoTweenCon.Instance.StartCoroutine(YuoTweenCon.Instance.IIntTo(f, value, needTime, floatTo, addSpeed, action));
        }
