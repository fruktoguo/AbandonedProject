    ...
    public class BuffManagerComponent : YuoComponent
    {
        ...
        public void AddBuff<T>(Main.Ecs.YuoEntity entity) where T : BuffComponent, new()
        {
            ...
            if (component == null)
            {
                ...
                World.RunSystem<IBuffCreateBefore>(component);
                if (component.BooleanOption.Get("CanAdd"))
                {
                    World.RunSystem<IBuffCreate>(component);
                }
                else
                {
                    World.RunSystem<IBuffCreateError>(component);
            ...
            else
            {
                ...
                {
                    component.BuffCount++;
                    World.RunSystem<IBuffAdd>(component);
                }
            }
        }
