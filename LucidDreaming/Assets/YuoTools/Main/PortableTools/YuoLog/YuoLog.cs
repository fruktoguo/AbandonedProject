...
namespace YuoTools
{
    public static class YuoLog
    {
        ...
        public static T Log<T>(this T obj)
        {
            ...
            Debug.Log($"<color=#FFF00FF>[{DateTime.Now:mm:ss:fff}-{UnityEngine.Time.frameCount}]</color>" + obj);
            return obj;
        }
        ...
        {
            if (!OpenDebug) return obj;
            Debug.LogError($"<color=#FFF00FF>[{DateTime.Now:mm:ss:fff}-{UnityEngine.Time.frameCount}]</color>" + obj);
            return obj;
        }
        ...
        {
            if (!OpenDebug) return obj;
            Debug.Log($"<color=#FFF00FF>[{DateTime.Now:mm:ss:fff}-{UnityEngine.Time.frameCount}]</color>" + 
