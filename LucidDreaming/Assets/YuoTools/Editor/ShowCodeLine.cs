...
namespace YuoTools.Editor
{
    public class ShowCodeLine : OdinEditorWindow
    {
        ...
        {
            [HorizontalGroup(width: 400)] [HideLabel]
            public string FileName;

            [HorizontalGroup(width: 75)] [HideLabel] [SuffixLabel("行", true)]
            public int LineCount;

            [HorizontalGroup(width: 75)] [HideLabel] [SuffixLabel("行", true)]
            public int FileCount;

            [HorizontalGroup(width: 75)] [HideLabel]
            ...
            [HorizontalGroup(width: 150)] [HideLabel]
